...
$stmt = $pdo->prepare("SELECT id, title, slug, category, country_code, status, photo, sort_order, created_at FROM articles $whereSQL ORDER BY sort_order ASC, created_at DESC LIMIT $perPage OFFSET $offset");
$stmt->execute($params);
...
<div class="panel">
    <div class="panel-header">
        ...
        <div class="panel-actions">
            <a href="/panel-5588/pages/article-edit.php" class="btn btn-primary btn-sm">+ Новая статья</a>
    ...
    <div style="padding:12px 16px;border-bottom:1px solid var(--border-light);display:flex;flex-wrap:wrap;gap:8px;align-items:center">
        <form method="GET" style="display:contents">
            ...
            <a href="/mod/articles.php" class="btn btn-secondary btn-sm">✕ Сбросить</a>
            <?php endif; ?>
        </form>
    </div>
    ...
    <div class="empty-state">
        ...
        <div class="empty-state-text">Попробуйте изменить фильтры или <a href="/panel-5588/pages/article-edit.php">добавьте первую статью</a></div>
    </div>
    <?php else: ?>
    <table class="table">
        <thead><tr>
        ...
        <tr>
            ...
            <td>
                <a href="/panel-5588/pages/article-edit.php?id=<?php echo $a['id']; ?>" class="btn btn-secondary btn-sm" title="Редактировать">✏️</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>
...
renderModLayout('Статьи — Полезное', $content);
?>
