...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .auth-forgot a:active { text-decoration: underline; }
...
<body>
    <div class="app-container">
        ...
        <div id="cookie-warning" style="display:none;margin-top:12px;padding:12px 16px;background:#FEF3C7;border:1px solid #F59E0B;border-radius:12px;font-size:13px;color:#92400E;">⚠️ В вашем браузере отключены cookie. Для входа на сайт необходимо включить cookie.<br><br><b>Opera на Android:</b> Меню → Настройки → Конфиденциальность → Файлы cookie → Разрешить</div>
            </form>
